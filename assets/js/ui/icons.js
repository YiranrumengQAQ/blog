...
(function () {
    ...
    const PATHS = {
        ...
        'book-open': '<path d="M12 7.5C10.5 6 8.5 5.3 4 5.3V18c4.5 0 6.5.7 8 2.2 1.5-1.5 3.5-2.2 8-2.2V5.3c-4.5 0-6.5.7-8 2.2z"/><path d="M12 7.5v12.7"/>',
        ...
        /* --- 雨夜玻璃主题：天气 / 水珠（线性 24 网格，与全站图标同风格） --- */
        droplet: '<path d="M12 2.7s6.5 7.1 6.5 11.4a6.5 6.5 0 0 1-13 0C5.5 9.8 12 2.7 12 2.7z"/><path d="M9.2 13.6a2.8 2.8 0 0 0 2 2.7"/>',
        droplets: '<path d="M7 4.5s4.2 4.6 4.2 7.4a4.2 4.2 0 0 1-8.4 0C2.8 9.1 7 4.5 7 4.5z"/><path d="M17 10s5.2 5.7 5.2 9.2a5.2 5.2 0 0 1-10.4 0C11.8 15.7 17 10 17 10z"/>',
        'cloud-rain': '<path d="M17.5 14.5H7a4 4 0 1 1 .6-7.96A5.5 5.5 0 0 1 18.3 7.8a3.8 3.8 0 0 1-.8 6.7z"/><path d="M8 17.5 7 21"/><path d="M12.5 17.5 11.5 21"/><path d="M17 17.5 16 21"/>',
        'cloud-drizzle': '<path d="M17.5 14.5H7a4 4 0 1 1 .6-7.96A5.5 5.5 0 0 1 18.3 7.8a3.8 3.8 0 0 1-.8 6.7z"/><path d="M8 18v.01"/><path d="M12.5 18v.01"/><path d="M17 18v.01"/><path d="M10.2 20.5v.01"/><path d="M14.7 20.5v.01"/>',
        'cloud-lightning': '<path d="M17.5 12.5H7a4 4 0 1 1 .6-7.96A5.5 5.5 0 0 1 18.3 5.8a3.8 3.8 0 0 1-.8 6.7z"/><path d="M12.8 12.5 10 17h2.6l-1.8 4.5 4.7-6H12.8z"/>',
        umbrella: '<path d="M12 2.5a8.5 8.5 0 0 1 8.5 8.5h-17A8.5 8.5 0 0 1 12 2.5z"/><path d="M12 11v8.5a2 2 0 0 0 4 0v-1"/>',
        wind: '<path d="M3 8h9.5a2.5 2.5 0 1 0-2.4-3.2"/><path d="M3 12.5h14a2.8 2.8 0 1 1-2.7 3.5"/><path d="M3 17h7"/>',
